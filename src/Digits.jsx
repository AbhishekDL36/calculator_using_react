...
function Digits({getVal,setOperator}) {
    return (
        <>
...
<Sum getVal={getVal} setOperator={setOperator}/>
...
<Subtract getVal={getVal} setOperator={setOperator} />
...
<Multiply getVal={getVal} setOperator={setOperator}/>
...
<p className="border-black border-[1px] border-solid  px-[70px] py-[20px]" onClick={()=>getVal('=')}>=</p>
<Divide getVal={getVal} setOperator={setOperator}/>
